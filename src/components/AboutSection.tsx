...
const AboutSection: React.FC = () => {
  return (
    <section
      id="about"
      className="relative py-24 bg-nature-dark text-oraleo-100 overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <span className="text-oraleo-400 font-bold tracking-widest text-xs uppercase">
              Our Philosophy
            </span>
            ...
            <p className="text-oraleo-200 text-lg leading-relaxed font-light">
              At Oraleo, we believe that fashion shouldn't cost the Earth. Our
              garments are crafted using 100% organic materials, natural dyes,
              and ethical labor practices. We take inspiration from the
              unhurried pace of nature.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8">
              <div className="flex flex-col gap-3">
                ...
                <p className="text-sm text-oraleo-300">
                  Cotton, linen, and hemp sourced responsibly.
                </p>
              </div>
              <div className="flex flex-col gap-3">
                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-oraleo-300">
                ...
                <p className="text-sm text-oraleo-300">
                  Water-saving techniques in every stitch.
                </p>
              </div>
              <div className="flex flex-col gap-3">
                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-oraleo-300">
