      ...
      <div className="container mx-auto px-6 pt-8">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative mb-16">
            ...
            <Search
              size={32}
              className="absolute right-0 top-1/2 -translate-y-1/2 text-nature-dark/40"
            />
          </div>
              ...
              {results.map((product) => (
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col justify-center">
                    <h4 className="font-serif text-lg text-nature-dark group-hover:text-nature-green transition-colors">
                      {product.name}
                    </h4>
                    <p className="text-sm text-nature-dark/60">
                      {product.category}
                    </p>
                    <span className="mt-2 font-medium text-nature-dark">
                      ${product.price}
                    </span>
                  </div>
